...
final mockPlaces = <Place>[
  ...
  Place(
    id: 'c1',
    name: 'Акимат города Жезказган',
    lat: 47.8062,
    lng: 67.7103,
    type: 'civic',
    description: 'Административный центр обслуживания граждан.',
  ),
  Place(
    id: 'p1',
    name: 'Парк Жастар',
    ...
    lng: 67.7131,
    type: 'park',
    description: 'Главная зона отдыха и городских фестивалей.',
  ),
  Place(
    id: 'h1',
    name: 'Городской медицинский центр',
    lat: 47.7993,
    lng: 67.7232,
    type: 'health',
    description: 'Многофункциональный госпиталь и поликлиника.',
  ),
  Place(
    id: 'c2',
    name: 'Центр медиации и сервисов',
    lat: 47.8088,
    lng: 67.7005,
    type: 'service',
    description: 'Единое окно для подачи документов и обращений.',
  ),
  Place(
    id: 'm1',
    name: 'Культурный дворец Байконура',
    lat: 47.7974,
    lng: 67.7032,
    type: 'culture',
    description: 'Современная площадка для концертов, форумов и выставок.',
  ),
];
